        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProducedBy = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductionLogs_Recipes_RecipeId",
                        column: x => x.RecipeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductionLogs_ProductionDate",
                table: "ProductionLogs",
                column: "ProductionDate");

            migrationBuilder.CreateIndex(
                name: "IX_ProductionLogs_RecipeId",
                table: "ProductionLogs",
                column: "RecipeId");
